...
const config = {
  ...
  categories: {
    "Internal Admin Time": { workflowStatuses: ["aActive Admin"] },
    "Internal Approved Projects": { workflowStatuses: ["aActive Internal"] },
    "Active Live Projects": { workflowStatuses: ["Active Climate", "Active Health", "Active PA", "Active Real Estate", "Active HOWL"] },
    "Active Support": { workflowStatuses: ["Active Support"] },
    "Active Web Warranty": { workflowStatuses: ["Active Web Warranty"] },
    "New Business Qualification": { sheetNames: ["NEW BIZ QUALIFICATION"] },
    "New Business Pipeline": { sheetNames: ["PIPELINE SHEET"] },
  },
